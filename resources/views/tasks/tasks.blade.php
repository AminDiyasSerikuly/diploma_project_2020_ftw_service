...
<link type="text/css" rel="stylesheet" href="{{ asset('css/creat.css?100') }}"/>
						...
						<div class="row">
							<div class="col m12 s12 files-upload">
								...
								<a href="" id="upload_link">
									{{-- <i class="material-icons veralmidd">attachment</i>  --}}
...
{{--								<input type="text" value="{{ App\Profile::getUserParam('user_address') }}" name="city" id="city" autocomplete="off" placeholder="Город" style="display:none;" disabled>--}}
							</div>
...
{{--						</div>--}}
						...
						<div class="row nomargin--b">
							<div class="col m12 s12 OrzuAdditionBlock">
								{{-- btn yellow darken-1 OrzuPromoBtn OrzuPromoBtnShadow waves-effect waves-light --}}
