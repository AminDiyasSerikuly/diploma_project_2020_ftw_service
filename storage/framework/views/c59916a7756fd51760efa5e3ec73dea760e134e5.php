...
if (isset($messageCache)) { $message = $messageCache; }
                    ...
                    <div class="input-field col m4 s4 link--info-reg nomargin verify">
                        <button class="waves-effect waves-light btn blue OrzuAuthBtn OrzuCheckPhone">
                    ...
                    <div class="input-field col m12 s12">
                        ...
                        <button class="waves-effect waves-light btn blue OrzuAuthBtn OrzuCheckCode" style="opacity:0;">
                    ...
                    <div class="input-field col m12 s12 OrzuInputHelperField">
                        <input id="password" type="password" autocomplete="off" name="password" data-password-validation="true" required disabled/>
...
</html><?php /**PATH /var/www/u0668441/data/www/projectapi.pw/resources/views/auth/register.blade.php ENDPATH**/ ?>