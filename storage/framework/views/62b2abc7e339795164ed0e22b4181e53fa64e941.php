...
<div class="container --general">
	<div class="row">
		<div class="col m8 s12 l7 --general-t">
			<?php if(Agent::isMobile()): ?>
			<div class="col s6"></div>
			<div class="col s6">
				<a class="waves-effect waves-light btn blue modal-trigger right" href="#modal1">Категории</a>
			</div>
			<?php endif; ?>
			<div class="main">
		...
		<?php if(Agent::isDesktop()): ?>
		<div class="col m4 s12 l5 --general-t">
			<div class="sidebar">
				<?php if(auth()->guard()->guest()): ?>
				<div class="--group OrzuPromoHead">
					<h6 class="nomargin--t"><a href="/login?utm_campaign=OrzuPromoHead">Зарегистрируйтесь или войдите</a>, чтобы выполнять заказы</h6>
				</div>
				<?php endif; ?>
					...
					<ul class="nomargin--t" id="ThisIsCatsList">
						...
						<li class="__js-filter-category-item">
							<div class="__js-filter-category-item--h">
								...
								?>
								<label class="__js-filter-category-label"><input type="checkbox" class="filled-in check" name="cat" data-id="itm<?php echo e($cat->id); ?>" data-name="item" <?php if($c=='yes'): ?> <?php echo e('checked'); ?> <?php endif; ?> value="<?php echo e($cat->id); ?>"/> <span><?php echo e($cat->name); ?></span></label>
							</div>
							<ul>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/u0668441/data/www/projectapi.pw/resources/views/tasks/alltasks.blade.php ENDPATH**/ ?>