...
<head>
    ...
    <script type="text/javascript" src="<?php echo e('js/jquery.min.js'); ?>"></script>
    ...
    <script src="<?php echo e(asset('js/home_page.js')); ?>"></script>
...
//         pushToDB();
                 ...
                 $.ajax({
            	url : 'http://projectapi.pw/tasks/ajaxupload',
            	method : "POST",
            	data : objectToSend,
            	dataType : "text",
        ...
        // 	url : 'http://projectapi.pw/tasks/ajaxupload',
        // 	method : "POST",
        // 	data : {id:id, find:find, cat:cat.join(","), offers:offers, beside:beside, status:status, _token:"ic1dPmPZnx6O3h1M7HfnxQxH5v3pGxiWg1F3gIIi"},
        // 	dataType : "text",
        // 	success : function (data) {
        // 		if(data != '') {
        // 			$('#remove-row').remove();
...
</html><?php /**PATH /var/www/u0668441/data/www/projectapi.pw/resources/views/test.blade.php ENDPATH**/ ?>